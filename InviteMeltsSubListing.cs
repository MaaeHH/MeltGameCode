...
public class InviteMeltsSubListing : Listing
{
    ...
    private InviteMeltsSubMenu theMenu;

    public void SetData(MeltData x, InviteMeltsSubMenu z)
    {
    ...
    public void Clicked()
    {
        ...
        theMenu.ListingClicked(thisData);
